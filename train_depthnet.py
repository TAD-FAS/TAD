...
train_writer = SummaryWriter(os.path.join("../tf-logs", "DLNR32_" + model_name))  # ../tf-logs
output_directory = os.path.join(opts.output_path, model_name + "_DLNR32/" + config['protocol'])
